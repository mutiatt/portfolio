...
import profilePic from "../images/portfoliopic.jpeg"; 
      ...
      <div className="container-xxl">
        <div className="row align-items-center d-flex">
          <div className="col-md-6">
            <img src={profilePic} alt="Mutiat's Portfolio" width={400} className="rounded-pill ms-2 my-5 me-5 py-5 img-fluid" />
          </div>

          <div className="col-md-6 header-text justify-content-between align-items-center">
            {/* <p className="display-5 ms-5">Hi,   */}
            <SplitText
                text= "Hi, I'm Mutiat"
          ...
          <div className="about-col-1 col-md-6">
            {/*
            {/* Tab Links */}
            ...
            <div className={`tab-contents ${activeTab === "skills" ? "active-tab" : ""}`} id="skills">
              <ul>
                <li><span>Web Development</span><br/>Html, Css, JavaScript, ReactJs, NodeJs</li>
